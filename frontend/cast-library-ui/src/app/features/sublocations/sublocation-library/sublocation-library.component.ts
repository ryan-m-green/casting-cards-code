...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, SublocationCardComponent, JournalTitleComponent, JournalWatermarkComponent, UpgradeBadgeComponent, CcKeywordEditorComponent],
