import { Component, inject, signal, Input, output, viewChild, ElementRef, OnInit } from '@angular/core';
...
@Component({
  selector: 'app-cc-party-gold-content',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './cc-party-gold-content.component.html',
  styleUrl: './cc-party-gold-content.component.scss'
})
export class CcPartyGoldContentComponent implements OnInit {
