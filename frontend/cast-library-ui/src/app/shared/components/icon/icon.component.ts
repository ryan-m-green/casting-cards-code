...
export type IconName = 'cast' | 'sublocation' | 'location' | 'faction' | 'campaign' | 'library' | 'player';
...
@Component({
  ...
  styles: [`
    ...
    .icon-svg { width: auto; height: 100%; display: block; flex-shrink: 0; opacity: var(--icon-opacity, 0.7); }
  `]
})
