...
@Component({
  selector: 'app-chronicle-content',
  standalone: true,
  imports: [CommonModule, FormsModule, ChroniclesTimelineComponent, StorylineFilterBarComponent],
  templateUrl: './chronicle-content.component.html',
  styleUrl: './chronicle-content.component.scss'
})
export class ChronicleContentComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.chroniclesSearchQuery.set(this.initialSearchQuery);
    this.loadChronicles();
