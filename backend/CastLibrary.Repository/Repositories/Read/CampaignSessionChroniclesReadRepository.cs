...
public interface ICampaignSessionChroniclesReadRepository
{
    ...
    Task<List<CampaignSessionChroniclesDomain>> GetBySessionIdAsync(Guid sessionId);
}
    ...
    ICampaignSessionChroniclesEntityMapper mapper) : ICampaignSessionChroniclesReadRepository
{
    ...
    public async Task<List<CampaignSessionChroniclesDomain>> GetBySessionIdAsync(Guid sessionId)
    {
        var spanId = correlation.NewSpan();
