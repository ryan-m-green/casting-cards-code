...
public class InvoicePaymentFailedStrategy : IInvoiceEventStrategy
{
    public string PaymentStatus => "failed";

    private readonly IStripeService _stripeService;
    private readonly IEmailOperator _emailOperator;
    private readonly IConfiguration _configuration;

    public InvoicePaymentFailedStrategy(IStripeService stripeService, IEmailOperator emailOperator, IConfiguration configuration)
    {
