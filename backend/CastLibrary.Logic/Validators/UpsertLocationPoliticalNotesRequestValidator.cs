...
public class UpsertLocationPoliticalNotesRequestValidator : AbstractValidator<UpsertLocationPoliticalNotesRequest>
{
    ...
    public UpsertLocationPoliticalNotesRequestValidator()
    {
